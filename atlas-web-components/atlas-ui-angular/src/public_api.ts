...
export * from './lib/atlas-tree/atlas-tree.module';
...
export * from './lib/atlas-header/components/atlas-header.component';
export * from './lib/atlas-menu/atlas-menu.module';
